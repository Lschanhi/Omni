    ...
    public class ProdutoService : IProdutoService
{
    ...
    public async Task<PagedResult<ProdutoLeituraDto>> GetPagedAsync(ProdutoFiltroDto filtro)
    {
        ...
        return new PagedResult<ProdutoLeituraDto>
        {
            Items = items,
            Total = total,
            Page = filtro.Page,
    ...
    {
        public IEnumerable<ProdutoLeituraDto> Items { get; set; }
